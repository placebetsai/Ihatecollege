  ...
  return (
    <Layout>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {/* Success message */}
        {sent && (
          <div className="bg-green-900/40 border border-green-700 rounded-xl p-6 mb-8 text-center">
            <h2 className="text-green-400 font-bold text-xl mb-2">Message Sent!</h2>
            <p className="text-green-300 text-sm">Thanks for reaching out. We typically respond within 24-48 hours.</p>
          </div>
        )}
        ...
        {!sent && (
          ...
          >
            ...
            <input type="hidden" name="_next" value="https://ihatecollege.com/contact?sent=true" />
